...
urlpatterns = [
    ...
    path("books/", views.category_page, {"item_type": "book"}, name="books"),
    path("discover/", views.discover, name="discover"),
    path("discover/movies-series/", views.discover_media, name="discover_media"),
    path("discover/books/", views.discover_books, name="discover_books"),
    path("people/", views.people_discovery, name="people"),
    ...
    path("review/<path:item_title>/", views.item_reviews, name="item_reviews"),
    path("items/<int:item_id>/", views.item_reviews_by_id, name="item_reviews_by_id"),
